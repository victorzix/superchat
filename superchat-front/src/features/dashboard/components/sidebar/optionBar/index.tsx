...
import {CiChat2, CiCircleList, CiSettings} from "react-icons/ci";
...
export default function  OptionBar() {
  ...
  return (
    <div className='w-auto h-full mt-auto h-auto p-4 flex flex-col gap-3 border-t py-8'>
      ...
      <OptionBarButton icon={<CiSettings/>} tab={4} className='mt-auto'/>
    </div>
  )
}